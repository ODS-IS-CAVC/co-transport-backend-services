...
public class DataBaseConstant {
    ...
    public static final class ReqCnsLineItemByDate {

        public static final String TABLE = "req_cns_line_item_by_date";
        public static final String ID = "id";
        public static final String OPERATOR_ID = "operator_id";
        public static final String OPERATOR_CODE = "operator_code";
        public static final String CNS_LINE_ITEM_ID = "req_cns_line_item_id";
        public static final String TRANS_PLAN_ID = "trans_plan_id";
        public static final String TRANSPORT_CODE = "transport_code";
        public static final String TRANSPORT_NAME = "transport_name";
        public static final String COLLECTION_DATE = "collection_date";
    ...
    public static final class DiagramItemTracking {
        ...
        public static final String TABLE = "c_diagram_item_tracking";
        public static final String TABLE_OPERATION = "c_diagram_item_operation_tracking";
    ...
    public static final class VehicleDiagramMobilityHub {
        ...
        public static final String TABLE = "c_vehicle_diagram_mobility_hub";
        public static final String ID = "id";
        public static final String VEHICLE_DIAGRAM_ITEM_ID = "vehicle_diagram_item_id";
    ...
    public static final class VehicleInfoCarrier {

        public static final String TABLE = "c_vehicle_info";
        public static final String ID = "id";
        public static final String OPERATOR_ID = "operator_id";
