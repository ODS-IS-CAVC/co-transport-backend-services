...
public class TrspPlanMsgInfo extends AbstractAuditingEntity<Long> implements Serializable {
    ...
    @Column(name = DataBaseConstant.TrspPlanMsgInfo.MSG_ID, precision = 5, scale = 0)
    private BigDecimal msgId;

    @Column(name = DataBaseConstant.TrspPlanMsgInfo.MSG_INFO_CLS_TYP_CD, length = 4)
    ...
    @Column(name = DataBaseConstant.TrspPlanMsgInfo.MSG_FN_STAS_CD, length = 1)
