...
@Setter
@NoArgsConstructor
public class TrspSrvcDeleteDTO {
    ...
    @ValidateField(notNull = true,
        dateFormat = DataBaseConstant.DATE_TIME_FORMAT.DATE_FORMAT,
        endDateField = "serviceEndDate", startTimeField = "serviceStrtTime", endTimeField = "serviceEndTime")
