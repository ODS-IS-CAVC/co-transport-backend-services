...
public class CarInfo extends AbstractAuditingEntity<Long> implements Serializable {
    ...
    @ManyToOne
    @JoinColumn(name = DataBaseConstant.CarInfo.TRSP_ABILLITY_LINE_ITEM_ID, nullable = false)
    @JsonIgnore
    ...
    @Column(name = DataBaseConstant.CarInfo.SERVICE_NAME, nullable = false, length = 50)
    private String serviceName;

    @Column(name = DataBaseConstant.CarInfo.CAR_CTRL_NUM_ID, nullable = true, length = 20)
    private String carCtrlNumId;

    @Column(name = DataBaseConstant.CarInfo.CAR_LICENSE_PLT_NUM_ID, nullable = true, length = 50)
    ...
    @Column(name = DataBaseConstant.CarInfo.TRAILER_LICENSE_PLT_NUM_ID, nullable = true, length = 50)
