package jp.co.nlj.ttmi.aop.proxy;
...
public @interface ValidateField {
    ...
    boolean msgFnStasCdType() default false;

    boolean trspNormalAbnormal() default false;

    boolean incidentCategory() default false;

    boolean incidentType() default false;
}
