...
public class CnsLineItemByDate extends AbstractAuditingEntity<Long> implements Serializable {
    ...
    @JsonProperty(value = DataBaseConstant.CnsLineItemByDate.OPERATOR_NAME)
    ...
    @JsonProperty(value = DataBaseConstant.CnsLineItemByDate.COLLECTION_DATE)
    private LocalDate collectionDate;

    @Column(name = DataBaseConstant.CnsLineItemByDate.COLLECTION_TIME_FROM)
    @JsonProperty(value = DataBaseConstant.CnsLineItemByDate.COLLECTION_TIME_FROM)
    private LocalTime collectionTimeFrom;

    @Column(name = DataBaseConstant.CnsLineItemByDate.COLLECTION_TIME_TO)
    @JsonProperty(value = DataBaseConstant.CnsLineItemByDate.COLLECTION_TIME_TO)
    ...
    @Column(name = DataBaseConstant.CnsLineItemByDate.TRANSPORT_PLAN_ITEM_ID)
    @JsonProperty(value = DataBaseConstant.CnsLineItemByDate.TRANSPORT_PLAN_ITEM_ID)
    ...
    @Column(name = DataBaseConstant.VehicleAvbResourceItem.IS_EMERGENCY)
