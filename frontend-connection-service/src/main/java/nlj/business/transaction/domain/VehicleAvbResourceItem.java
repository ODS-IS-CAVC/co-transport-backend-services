...
public class VehicleAvbResourceItem extends AbstractAuditingEntity<Long> implements Serializable {
    ...
    @Column(name = DataBaseConstant.VehicleAvbResourceItem.VEHICLE_AVB_RESOURCE_ID)
    ...
    @Column(name = DataBaseConstant.VehicleAvbResourceItem.GIAI, nullable = false, length = 30)
    private String giai;
