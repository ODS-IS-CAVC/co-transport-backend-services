...
/**
 * <PRE>
 * 出発地プライマリ情報レスポンスDTO。<BR>
 * </PRE>
 *
 * @author Next Logistics Japan
 */
@Data
public class ShipFromPrtyResponseDTO {
    ...
    public static ShipFromPrtyResponseDTO fromResult(Object[] result) {
        ShipFromPrtyResponseDTO dto = new ShipFromPrtyResponseDTO();
