package nlj.business.transaction.dto.trip.cnsLineItem.request;
...
public class CnsLineItemDTO {
    ...
    public static CnsLineItemDTO fromResult(Object[] result) {
        CnsLineItemDTO dto = new CnsLineItemDTO();
