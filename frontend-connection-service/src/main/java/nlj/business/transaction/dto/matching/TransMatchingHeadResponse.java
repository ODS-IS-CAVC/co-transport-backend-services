...
@Setter
@AllArgsConstructor
public class TransMatchingHeadResponse {
    ...
    @JsonProperty("partner_1")
    private PartnerTrailerResponse partner1;

    @JsonProperty("partner_2")
    private PartnerTrailerResponse partner2;
}
