package nlj.business.transaction.dto.trip.shipFromPrty.response;
...
/**
 * <PRE>
 * 出発地プライマリ要求レスポンスDTO。<BR>
 * </PRE>
 *
 * @author Next Logistics Japan
 */
@Data
public class ShipFromPrtyRqrmResponseDTO {
    ...
    public static ShipFromPrtyRqrmResponseDTO fromResult(Object[] result) {
        ShipFromPrtyRqrmResponseDTO dto = new ShipFromPrtyRqrmResponseDTO();
