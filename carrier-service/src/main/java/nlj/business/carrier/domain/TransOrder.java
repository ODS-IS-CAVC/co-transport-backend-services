...
import nlj.business.carrier.converter.CnsLineItemByDateSnapshotConverter;
import nlj.business.carrier.converter.NegotiationDataConverter;
import nlj.business.carrier.converter.VehicleAvbResourceItemSnapshotConverter;
...
public class TransOrder implements Serializable {
    ...
    @CreatedBy
    @Column(name = DataBaseConstant.TransOrder.CREATED_USER, nullable = false, length = 50, updatable = false)
    private String createdUser = "Admin";

    @CreatedDate
    @Column(name = DataBaseConstant.TransOrder.CREATED_DATE, updatable = false)
    private LocalDateTime createdDate = LocalDateTime.now();

    @LastModifiedBy
    @Column(name = DataBaseConstant.TransOrder.UPDATED_USER, length = 50)
    private String updatedUser = "Admin";

    @LastModifiedDate
    @Column(name = DataBaseConstant.TransOrder.UPDATED_DATE)
