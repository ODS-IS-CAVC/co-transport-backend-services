 ...
 */
@Data
public class ShipperOperationReserveRequestDTO {
    ...
    @ValidateField(notNull = true, textHalfWidth = true)
    private String serviceNo; // 便・ダイヤ番号

    @JsonProperty("trsp_op_date_trm_strt_date")
    @ValidateField(notNull = true, dateFormat = DataBaseConstant.DATE_TIME_FORMAT.DATE_FORMAT, textHalfWidth = true, endDateField = "trspOpDateTrmStrtDate")
