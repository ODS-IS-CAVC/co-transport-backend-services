...
public class ReqTrspPlanMsgInfo extends AbstractAuditingEntity<Long> implements Serializable {
    ...
    @Column(name = DataBaseConstant.ReqTrspPlanMsgInfo.MSG_ID, precision = 5, scale = 0, nullable = false)
    private BigDecimal msgId;

    @Column(name = DataBaseConstant.ReqTrspPlanMsgInfo.MSG_INFO_CLS_TYP_CD, length = 4, nullable = false)
    ...
    @Column(name = DataBaseConstant.ReqTrspPlanMsgInfo.MSG_FN_STAS_CD, length = 1, nullable = false)
